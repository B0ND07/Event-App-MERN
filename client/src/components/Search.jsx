...
import { setHasSearched } from "../redux/slices/eventSlice";

function Search() {
  const { searchEvent } = useSelector((state) => state.EventState);
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full flex flex-wrap">
        {Array.isArray(searchEvent) && searchEvent.length > 0 ? (
          ...
          <div className="w-full flex flex-col justify-center items-center h-[50vh] font-medium text-xl md:text-2xl">
            <p className="">No Events found for the specified query.</p>
            <br></br>
